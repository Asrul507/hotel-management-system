...
export default function SettingsPage() {
  ...
  return <div className="page-stack">
    ...
    <div className="two-column">
      <div className="card detail-list"><h2>Profile User</h2><p><strong>Nama:</strong> {profile?.full_name || '-'}</p><p><strong>Username:</strong> {profile?.username || '-'}</p><p><strong>Role:</strong> <span className="badge">{profile?.role || '-'}</span></p><p><strong>Status:</strong> {profile?.is_active ? 'Aktif' : 'Tidak aktif'}</p></div>

...
const tabs = [['input', 'Input Reservasi'], ['bayar', 'Bayar Folio'], ['report', 'Data / Report']];
...
export default function FrontOfficePage() {
  ...
  useEffect(() => {
    const nextTab = params.get('tab') || 'input';
    if (tabKeys.includes(nextTab) && nextTab !== activeTab) setActiveTab(nextTab);
  }, [params, activeTab]);
